...
func (c *mediaServiceClient) GetPhotoUploadUrl(ctx context.Context, in *GetPhotoUploadUrlRequest, opts ...grpc.CallOption) (*GetPhotoUploadUrlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPhotoUploadUrlResponse)
	err := c.cc.Invoke(ctx, MediaService_GetPhotoUploadUrl_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MediaService_GetPhotoUploadUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPhotoUploadUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MediaServiceServer).GetPhotoUploadUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MediaService_GetPhotoUploadUrl_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MediaServiceServer).GetPhotoUploadUrl(ctx, req.(*GetPhotoUploadUrlRequest))
	}
...
var MediaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "saladineye.MediaService",
